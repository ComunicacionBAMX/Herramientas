...
// Crear el elemento del efecto
const glitch = document.createElement('div');
glitch.className = 'cyber-glitch';
glitch.innerHTML = '&#9822;'; // Código Unicode del Caballo de Ajedrez
...
botones.forEach(boton => {
    boton.addEventListener('click', function() {
        // Solo se activa si no tiene la clase 'usado'
        if (!this.classList.contains('usado')) {
            glitch.classList.add('active');
            
            // Eliminar la clase después de la animación para que pueda limpiar
            setTimeout(() => {
                glitch.classList.remove('active');
            }, 500);

            // Marcar como usado para que no vuelva a salir en este botón
